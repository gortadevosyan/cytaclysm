...
{-| judge whether two coordinate is same
-}
...
{-| give the distance of two coordinate
-}
dist : ( Int, Int ) -> ( Int, Int ) -> Float
dist ( x1, y1 ) ( x2, y2 ) =
    sqrt ((toFloat x1 - toFloat x2) ^ 2 + (toFloat y1 - toFloat y2) ^ 2)


{-| judge whether two float coordinate is same
-}
